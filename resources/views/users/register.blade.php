            ...
            <div class="card-body">
                ...
                <form action="/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group">
                        <input class="input--style-3" type="text" placeholder="National Id" name="nid" value="{{old('nid')}}">
                        @error('nid')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="input-group">
                        <input class="input--style-3 js-datepicker" type="text" placeholder="fullname" name="name">
                        @error('name')
                        <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="file" id="img" name="student_image" accept="image/*">
{{--                        @error('student_image')--}}
{{--                        <div class="alert alert-danger">{{ $message }}</div>--}}
{{--                        @enderror--}}
                    </div>
